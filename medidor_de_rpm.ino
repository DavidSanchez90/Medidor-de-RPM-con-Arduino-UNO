...
const int PinOut             = 13;  // Pin de salida para señal que muestre 
...
void loop()
{
  ...
  rpm=(count*60)/12;       // Operacion que combierte la cantidad de pulsos leida 
                           //  a rpm
     Serial.print(rpm);    // Muestra dato de RPM en Serial
     Serial.println(" RPM");
}
